...
export function CardCourse({id, imageCourse, titleCourse }) {
    return (
        <div key={id} className="bg-white border border-gray-300 max-w-80 w-full md:w-[35%] lg:w-[25%] mx-4 my-4 rounded-xl flex-grow">
            <div className="h-full max-w-xl mx-auto rounded-md overflow-hidden flex flex-col justify-between">
                ...
                <div className="px-4 pb-4 w-full flex items-center justify-center mt-9">
                    <NavLink to={`/courseEvents/${id}`} type="submit"

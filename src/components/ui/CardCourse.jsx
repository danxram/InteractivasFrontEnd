...
export function CardCourse({imageCourse, titleCourse}) {
    return (
        <div className="bg-[#D9D9D9] w-[55%] md:w-[35%] lg:w-[25%] mx-4 my-4 h-full rounded-xl">
        <div
            className=" h-full max-w-xl mx-auto  rounded-md overflow-hidden flex flex-col">
            <div className="m-4">
                <div className="h-[150px] min-h-[25vh] flex items-center justify-center">
                    <img src={`${imageCourse}`} alt="Imagen" className="h-auto max-h-full max-w-full"/>
                </div>
            </div>

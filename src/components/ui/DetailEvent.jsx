...
export function DetailEvent({ eventName, imageEvent, date, hour, group, status, mode, description, type }) {
    return (
        <div className="flex flex-wrap lg:flex-nowrap p-10 bg-white m-5 rounded-2xl border border-[#274F7E] ff-main">
            <div>
                ...
                <div className="flex gap-2 m-4 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" height="30" width="30" viewBox="0 0 512 512">
                        <path fill="#28d025" d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512z" />
                    </svg>
                ...
                <div className="flex flex-wrap lg:flex-nowrap gap-4">
                    ...
                    <button className="group flex justify-center items-center p-2 bg-white rounded-xl border border-[#274F7E] text-[#426B9A] font-medium transition-colors duration-300 w-40 hover:bg-[#274F7E] hover:text-white">
                        ...
                        <p className="ff-main text-xl sm:text-sm transition-colors duration-300 group-hover:text-white">{type}</p>
                    </button>
                </div>
            </div>
            ...
            <div>
                ...
                <div className="text-right">
                    <p className="ff-main text-2xl sm:text-sm text-[#274F7E]"><span className="font-bold">Date:</span> {date}</p>
                    <p className="ff-main text-2xl sm:text-sm text-[#274F7E]"><span className="font-bold">Time:</span> {hour}</p>
                </div>
                <div>

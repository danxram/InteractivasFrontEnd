...
export function CardEvent({id, imageEvent, date, eventName, description, categorie, status }) {
    ...
    return (
        <div key={id} className="flex flex-col bg-[#D9D9D9] rounded-lg h-full">
            <div className="w-full rounded-t-lg">
                <img className="w-full h-[50vh] rounded-t-lg" src={`${imageEvent}`} alt="" />
            </div>
            ...
            <div className="flex m-4 justify-evenly">
                <div className="flex flex-row bg-[#ffffff] rounded-lg h-7 w-32 px-2 gap-1">
                    ...
                    <p className="font-main text-base text-[#426B9A]">{status}</p>
                </div>
                <div className="flex flex-row bg-[#90BD8C] rounded-lg h-7 w-30 justify-center px-2 gap-1">
                    ...
                    <p className="font-main text-base text-white">{categorie}</p>
                </div>
            </div>
            <div className="flex flex-col flex-grow">
                ...
                <div className="flex justify-center mb-6">
                    <NavLink to={`/details/${id}`} className="font-main text-xl font-bold py-5 px-10 bg-[#C94545] rounded-lg text-[#ffffff]" href="">View More</NavLink>
                </div>
            </div>
        </div>

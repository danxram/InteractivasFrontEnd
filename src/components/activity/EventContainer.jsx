...
export function EventContainer({ items }) {
    ...
    return (
        <>
            <div class="flex w-auto justify-center mx-9">
                <h3 class="text-[#0F345F] font-main font-bold text-4xl tracking-widest text-center">EVENT OVERVIEW</h3>
            </div>
            ...
            <div class="flex justify-center mb-6 sm:mb-14">
                <a class="font-main text-4xl font-bold py-5 px-10 xl:px- 2xl:px-24 bg-[#0F345F] rounded-lg text-[#ffffff]" href="">Show More</a>
            </div>
